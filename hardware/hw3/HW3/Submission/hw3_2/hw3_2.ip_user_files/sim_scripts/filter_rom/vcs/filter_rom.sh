...
#                script (type 'filter_rom.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.filter_rom xil_defaultlib.glbl -o filter_rom_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./filter_rom_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key filter_rom_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc filter_rom_simv.daidir vcs_lib c.obj)
