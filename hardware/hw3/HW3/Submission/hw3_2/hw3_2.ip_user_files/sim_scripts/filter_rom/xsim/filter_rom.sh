...
#
# Script generated by Vivado on Sat Nov 11 14:20:44 +0530 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : filter_rom.sh
...
#
# Usage        : filter_rom.sh
#                filter_rom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                filter_rom.sh [-reset_run]
#                filter_rom.sh [-reset_log]
#                filter_rom.sh [-help]
#
...
# script info
echo -e "filter_rom.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./filter_rom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot filter_rom xil_defaultlib.filter_rom xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim filter_rom -key {Behavioral:sim_1:Functional:filter_rom} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb filter_rom.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./filter_rom.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: filter_rom.sh [-help]\n\
Usage: filter_rom.sh [-step]\n\
Usage: filter_rom.sh [-lib_map_path]\n\
Usage: filter_rom.sh [-reset_run]\n\
Usage: filter_rom.sh [-reset_log]\n\
Usage: filter_rom.sh [-keep_index]\n\
Usage: filter_rom.sh [-noclean_files]\n\n\
