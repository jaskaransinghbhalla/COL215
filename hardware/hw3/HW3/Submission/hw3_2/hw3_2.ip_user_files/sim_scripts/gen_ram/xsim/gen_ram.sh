...
#
# Script generated by Vivado on Mon Nov 13 23:12:25 +0530 2023
...
#
# Usage        : gen_ram.sh
#                gen_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gen_ram.sh [-reset_run]
#                gen_ram.sh [-reset_log]
#                gen_ram.sh [-help]
#
...
# script info
echo -e "gen_ram.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gen_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gen_ram xil_defaultlib.gen_ram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim gen_ram -key {Behavioral:sim_1:Functional:gen_ram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb gen_ram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./gen_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: gen_ram.sh [-help]\n\
Usage: gen_ram.sh [-step]\n\
Usage: gen_ram.sh [-lib_map_path]\n\
Usage: gen_ram.sh [-reset_run]\n\
Usage: gen_ram.sh [-reset_log]\n\
Usage: gen_ram.sh [-keep_index]\n\
Usage: gen_ram.sh [-noclean_files]\n\n\
