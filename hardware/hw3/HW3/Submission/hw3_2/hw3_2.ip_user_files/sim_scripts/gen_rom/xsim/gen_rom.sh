...
#
# Script generated by Vivado on Tue Nov 14 17:33:18 +0530 2023
...
#
# Usage        : gen_rom.sh
#                gen_rom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gen_rom.sh [-reset_run]
#                gen_rom.sh [-reset_log]
#                gen_rom.sh [-help]
#
...
# script info
echo -e "gen_rom.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gen_rom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot gen_rom xil_defaultlib.gen_rom -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim gen_rom -key {Behavioral:sim_1:Functional:gen_rom} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb gen_rom.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./gen_rom.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: gen_rom.sh [-help]\n\
Usage: gen_rom.sh [-step]\n\
Usage: gen_rom.sh [-lib_map_path]\n\
Usage: gen_rom.sh [-reset_run]\n\
Usage: gen_rom.sh [-reset_log]\n\
Usage: gen_rom.sh [-keep_index]\n\
Usage: gen_rom.sh [-noclean_files]\n\n\
