...
HD_PWD='D:/col215/hw3_2/hw3_2.runs/filter_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log filter_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source filter_rom.tcl
