...
HD_PWD='D:/col215/hw3_2/hw3_2.runs/gen_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gen_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gen_ram.tcl
