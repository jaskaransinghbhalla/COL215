...
HD_PWD='D:/col215/hw3_2/hw3_2.runs/gen_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gen_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gen_rom.tcl
